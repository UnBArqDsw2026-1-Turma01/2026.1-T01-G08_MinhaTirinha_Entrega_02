...
| [Raissa](https://github.com/daischa19) | <a href="#/Modelagem/2.3.ModelagemOrganizacionalCasosDeUso?id=_231-diagrama-de-pacotes">Diagrama de Pacotes</a> | 21/04/2026 | 
...
| Nome | Função | Data |
|------|--------|------|
| [Samara Alves](https://github.com/SamaraAlvess) | Fatoração do artefato | 21/04/2026 | 
...
<p align="center"><em>Fonte: Samara Alves, Ana Carolina, Gabriel Pinto, Marjorie, Raissa, 2026.</em></p>

### Comentários sobre o trabalho em equipe

- Samara: O diagrama de pacotes foi essencial para estruturar o sistema em módulos lógicos. A discussão em grupo foi necessária para definir nomes claros para cada camada e o uso correto dos estereótipos `<<import>>` e `<<access>>`.
...
| 1.1 | 23/04/2026 | Adicionando o diagrama de pacote | [Samara Alves](https://github.com/SamaraAlvess3) | [Gabriel Pinto](https://github.com/GabrielSPinto) |
...
| 1.3 | 23/04/2026 | Adição dos comentários sobre o Diagrama de Pacotes | [Ana Carolina](https://github.com/anawcarol) e [Samara Alves](https://github.com/SamaraAlvess3) | [Gabriel Pinto](https://github.com/GabrielSPinto) |
