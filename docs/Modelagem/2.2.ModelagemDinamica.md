...
| **Marjorie Mitzi** | Diagrama de Sequência | A revisão dos diagramas de sequência contribuiu para identificar inconsistências e melhorar a clareza das interações representadas. O trabalho permitiu visualizar melhor a responsabilidade de cada componente e reforçou a importância da modelagem dinâmica para apoiar a implementação das funcionalidades do projeto. |
