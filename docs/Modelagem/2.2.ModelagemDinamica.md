...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="#/Modelagem/2.2.ModelagemDinamica?id=flyan1">Diagrama de Sequência 1</a> e <a href="#/Modelagem/2.2.ModelagemDinamica?id=flyan2">Diagrama de Sequência 2</a></td>
      <td>23/04/2026</td>
      <td>10:00</td>
    </tr>
    <tr>
      ...
      <td><a href="#/Modelagem/2.2.ModelagemDinamica?id=diagrama-estados">Diagrama de Estados</a></td>
      <td>23/04/2026</td>
      <td>18:00</td>
    </tr>
        <tr>
...
De acordo com o livro UML 2: Uma Abordagem Prática, os diagramas dinâmicos têm como foco “modelar os aspectos comportamentais do sistema”, evidenciando interações, sequências de ações e mudanças de estado.

Assim, a modelagem dinâmica torna-se essencial para compreender não apenas o que o sistema é, mas principalmente como ele funciona na prática.

*Redigido por [Maria Samara Alves](https://www.github.com/SamaraAlvess).*
...
### Autenticação de Usuário :id=flyan1

Diz respeito ao primeiro passo da nossa aplicação representando o momento logo após a abertura do aplicativo, onde ele precisará criar uma conta (sendo isso opcional) ou logar em sua conta já existente.
O diagrama ressalta bastante a comunicação com os componentes do backend (module, controller, service) e do consumo dos componentes do banco de dados.  

*Redigido por [Guilherme Flyan](https://www.github.com/GFlyan).*

![Diagrama de Sequência](../assets/DS-AU.png)
<p align="center"><em>Fonte: Guilherme Flyan, 2026.</em></p>

Para melhor visualização acesse o link externo de acesso ao diagrama: [Draw.io - Diagrama de Sequência:  Autenticação de Usuário](https://drive.google.com/file/d/1fF6VLbHMo7P8NAymSDiuqILawzG0boig/view?usp=drive_link).
...
### Visualizar Tirinhas Não Iniciadas :id=flyan2

Diz respeito ao segundo passo da nossa aplicação representando o momento de encontrar as tirinhas que ainda não foram inicializadas pelo usuário, para que posteriormente o usuário possa escolher uma tirinha para pintar/ler.
Esse diagrama também ressalta bastante a comunicação com os componentes do backend (module, controller, service) e do consumo dos componentes do banco de dados. 
...
Para melhor visualização acesse o link externo de acesso ao diagrama: [Draw.io - Diagrama de Sequência: Tirinhas Não Iniciadas](https://drive.google.com/file/d/1fF6VLbHMo7P8NAymSDiuqILawzG0boig/view?usp=sharing).
...
| **Guilherme Flyan** | Diagrama de Sequência | Dentre todos os diagramas da entrega 2 que desenvolvi os mais complicados foram os de sequência principalmente pelo fato de descobrir bastante novas classes que serão utilizadas no projeto e também pela dificuldade de compreender corretamente o fluxo de vida de um dado objeto. |
...
De acordo com o estudo apresentado por Karen Miyuki Nakazato e Guilherme Horta Travassos (Desenvolvimento de uma Técnica de Inspeção de Diagrama de Estados com apoio dos Diagramas de Atividades descrevendo os Casos de Uso do Software), os diagramas de atividades são amplamente utilizados na especificação de casos de uso, descrevendo as atividades realizadas pelo sistema e apoiando a validação dos requisitos definidos .

Assim, esse tipo de diagrama não apenas representa o fluxo de execução, mas também desempenha um papel fundamental na verificação da consistência entre requisitos e demais modelos UML, contribuindo para a qualidade do software desenvolvido.

Redigido por: [Ana Carolina Madeira Fialho](https://github.com/anawcarol)
...
>>UML 2 Uma abordagem prática. Disponível em: <https://books.google.com.br/books?hl=pt-BR&lr=&id=mJxMDwAAQBAJ&oi=fnd&pg=PT4&dq=diagrama+de+pacotes+software&ots=xayWOmXGp5&sig=EmyOSQlS_rCqgPeXsYyzWOj_zQ8&redir_esc=y#v=onepage&q=diagrama%20de%20pacotes%20software&f=false>. Acesso em: 24 abr. 2026.
>>Desenvolvimento de uma Técnica de Inspeção de Diagrama de Estados com apoio dos Diagramas de Atividades descrevendo os Casos de Uso do Software. Disponível em: <htps://repositorio.ufsc.br/bitstream/handle/123456789/104703/331018.pdf?sequence=1&isAllowed=y>. Acesso em: 24 abr. 2026.
...
| 2.8 | 24/04/2026 | Ajustes na documentação, diagrama de atividades| [Ana Carolina](https://github.com/anawcarol) | [Gabriel Pinto](https://github.com/GabrielSPinto) |
[Marjorie](https://github.com/Marjoriemitzi)
| 2.9 | 24/04/2026 | Adição de referências e opinião pessoal| [Guilherme Flyan](https://github.com/GFlyan) | --- |
