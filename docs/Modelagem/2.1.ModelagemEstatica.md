...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><a href="#/Modelagem/2.1.ModelagemEstatica?id=classes">Diagrama de Classes</a></td>
      <td>21/04/2026</td>
      <td>15:30</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><a href="#/Modelagem/2.1.ModelagemEstatica?id=diagrama-componentes">Diagrama de Componentes</a></td>
      <td>21/04/2026</td>
      <td>15:30</td>
    </tr><tr>
      <td><a href="https://github.com/JoaoMarceloGCN">João Marcelo Guimarães Costa Naves</a></td>
      <td><a href="#/Modelagem/2.1.ModelagemEstatica?id=diagrama-componentes">Diagrama de Componentes</a></td>
      <td><a href="https://github.com/SamaraAlvess">Maria Samara Alves Silva</a></td>
      <td><a href="#/Modelagem/2.1.ModelagemEstatica?id=classes">Diagrama de Classes</a></td>
      <td>21/04/2026</td>
      <td>15:30</td>
    </tr>
...
### Introdução
As etapas de engenharia de requisitos e de projeto produzem muitos artefatos, tais
como modelos UML, [...]. O objetivo desta linguagem é permitir a criação de modelos gráficos que auxiliem engenheiros de software a entender o produto que será desenvolvido. Um dos modelos mais utilizados da UML é o diagrama de classes, que proporciona uma visão de como as classes estarão organizadas, como elas se relacionam e quais seus atributos e métodos [Guedes 2018].

*Redigido por [Ana Carolina Madeira Fialho](https://www.github.com/anawcarol).*

### Como o diagrama de classes agrega ao projeto
No nosso projeto, o diagrama de classes foi desenvolvido para representar as principais entidades do sistema. O diagrama reflete uma separação clara entre a interface do usuário (Frontend), a lógica de negócio (Domínio) e a persistência de dados (Backend/Infraestrutura).


<font size="3"><p style="text-align: center">Tabela 2: Autores e funções</p></font>
...
| [Marjorie Mitzi Cavalcante Rodrigues](https://github.com/Marjoriemitzi) | Revisão |


### Representação do Diagrama :id=classes

<p align="center"><em>Figura 1: Diagrama de Classes</em></p>

![Diagrama de Classes](../assets/Diagrama_de_classes.jpg)

<p align="center"><em>Fonte: <a href="https://github.com/anawcarol">Ana Carolina Madeira Fialho</a>, <a href="https://github.com/GabrielSPinto">Gabriel Santos Pinto</a> e <a href="https://github.com/SamaraAlvess">Maria Samara Alves Silva</a>, 2026.</em></p>
...
| :--- | :--- | :--- |
| [Ana Carolina Fialho](https://github.com/anacarolinamadeirafialho) | Fatoração Diagrama de Classes | A construção do diagrama de classes me ajudou a entender como é possível identificar gargalos e validar os requisitos de forma mais sucinta, antes mesmo de sequer começar a programar o software. Além disso, a forma como ele pode apresentar-se intuitivo, de modo que qualquer desenvolvedor seja capaz de compreender demonstra a sua praticidade e relevância! Inicialmente, construimos o diagrama apenas com fluxos da interface, e mais tarde, comparando com os requisitos realizados identificamos a necessidade de classes com metodos que suprissem essa problematica. Nesse sentido, adicionamos novas classes ao diagrama, como o GestaoContaService e GibiDataService. |
| [Gabriel Santos Pinto](https://github.com/gabriel-santos-pinto) | Revisão Diagrama de Classes | A construção do diagrama de classes me ajudou a visualizar melhor a estrutura do sistema e a relação entre suas principais classes. Também foi útil para perceber ajustes necessários antes da implementação, alinhando melhor o modelo aos requisitos do projeto. |
| [Maria Samara Alves ](https://github.com/SamaraAlvess) | Fatoração | O diagrama de classe na minha visão acabou sendo a atividade mais complexa dessa entrega, tivemos que refinar para integrar algumas classes do backend, mas foi uma tarefa divertida com o auxílio dos materiais teóricos disponibilizados pela professora. |
| [Marjorie Mitzi Cavalcante Rodrigues](https://github.com/Marjoriemitzi) | Revisão | Revisei as classes, relacionamentos e multiplicidades para garantir coerência com o projeto. |


---

<a id="diagrama-componentes"></a>
## 2. Diagrama de Componentes

### Introdução
 
O Diagrama de Componentes é uma representação da UML (Unified Modeling Language) voltada para a organização física e lógica de um sistema. Ela mostra como o software é decomposto em partes menores e foca na conexão e responsabilidade de cada módulo. 
...
<font size="3"><p style="text-align: center">Tabela 4: Comentários dos participantes</p></font>

| Autor | Comentário |
| :--- | :---: |
| **[Joao Marcelo Guimaraes Costa Naves](https://github.com/JoaoMarceloGCN)** | Sobre o diagrama de componentes, achei um pouco desafiador no início, principalmente na definição das responsabilidades de cada parte do sistema. Porém, com as discussões em grupo, o entendimento foi melhorando e o trabalho fluiu um pouco melhor. A separação entre backend e frontend exigiu bastante atenção, mas ajudou a enxergar melhor a arquitetura. |
| **[Pedro Henrique Pereira Santos](https://github.com/pedrohpsantos)** | A elaboração do diagrama de componentes em grupo tornou a arquitetura do projeto concreta e alinhou a equipe. Definir claramente os subsistemas e suas responsabilidades estabeleceu uma base sólida para a implementação, o que guiará as decisões técnicas e evitará retrabalhos. |
| **[Raissa Silva De Oliveira](https://github.com/Daisha19)** | Inicialmente, tive dificuldade com as notações e conexões da UML. No entanto, ao compreender o fluxo da aplicação e a divisão de responsabilidades entre as camadas, as interfaces e dependências do diagrama de componentes tornaram-se mais claras e coerentes. |

<font size="2"><p style="text-align: center">Fonte: Equipe do Projeto, 2026.</p></font>

<font size="3"><p style="text-align: center">Tabela 5: Autores e funções</p></font>

| Autores | Função |
| :--- | :--- |
| [Joao Marcelo Guimaraes Costa Naves](https://github.com/JoaoMarceloGCN) | Fatoração, diagramação e revisão |
| [Pedro Henrique Pereira Santos](https://github.com/pedrohpsantos) | Fatoração, diagramação e revisão |
| [Raissa Silva De Oliveira](https://github.com/Daisha19) | Fatoração, diagramação e revisão |

### Referências

LUCID SOFTWARE. What is a UML Component Diagram? Disponível em: <https://www.lucidchart.com/pages/uml-component-diagram>. Acesso em: 24 abr. 2026.

VISUAL PARADIGM. What is Component Diagram? Disponível em: <https://www.visual-paradigm.com/guide/uml-unified-modeling-language/what-is-component-diagram/>. Acesso em: 24 abr. 2026.

YOUTUBE. UML Component Diagram Tutorial. Disponível em: <https://www.youtube.com/watch?v=yjFpwFZHGtw>. Acesso em: 24 abr. 2026.
...
<p align="center"><em>Fonte: Guilherme Flyan, Marjorie Mitzi, Davi Negreiros e Yasmin Albuquerque, 2026.</em></p>


Para melhor visualização acesse o link externo de acesso ao diagrama: [LucidChart - Diagrama de Implantação](https://lucid.app/lucidchart/405f5869-4ba5-4ab8-99f7-cb35aeb0613c/edit?viewport_loc=-58%2C-12%2C2294%2C1104%2C0_0&invitationId=inv_82a1f232-688a-4ff4-be8b-4457c2da29f2).


<font size="3"><p style="text-align: center">Tabela 6: Autores e funções</p></font>

| Autores | Função |
| :--- | :--- |
| [Davi Monteiro De Negreiros](https://github.com/DaviNegreiros) | Fatoração |
| [Guilherme Flyan Araujo](https://github.com/GFlyan) | Fatoração e refatoração do artefato |
| [Marjorie Mitzi Cavalcante Rodrigues](https://github.com/Marjoriemitzi) | Fatoração e refatoração do artefato |
| [Yasmin Dayrell Albuquerque](https://github.com/YasminDayrell) | Fatoração |
...
O NestJS foi escolhido principalmente por sua arquitetura modular que pode ser explicada da seguinte forma: "O NestJS incentiva a criação de aplicativos com uma arquitetura modular e organizada. Ele utiliza conceitos como módulos, controladores e provedores para dividir o código em partes reutilizáveis e independentes, tornando o desenvolvimento mais organizado e fácil de manter." ([LUIZ DUARTE, Tutorial NestJS para Iniciantes](https://www.luiztools.com.br/post/tutorial-nestjs-para-iniciantes/)).
...
- **Davi**: Foi bem trabalhoso e confuso fazer esse diagrama, não sabíamos muito bem onde estávamos pisando. Na primeira reunião passamos mais de hora discutindo sobre como ele devia ficar e tentando entender. Mas com a orientação da professora nós conseguimos um norte mais firme.
...
* LUIZ DUARTE. **Tutorial NestJS para Iniciantes**. luiztools, 7 setembro. 2023. Disponível em: <https://www.luiztools.com.br/post/tutorial-nestjs-para-iniciantes/>. Acesso em: 24 abr. 2026.
...
* Débora dos Santos e Siqueira, Matheus Montanha Paulon, Gilleanes Thorwald Araujo Guedes. **Técnicas de Inspeção para Diagramas de Classes UML: Uma Revisão Sistemática**. Diponível em: <https://sol.sbc.org.br/index.php/eres/article/view/8494/8395>. Acesso em: 24 abr. 2026.
...
| 1.7 | 24/04/2026 | Adição de Textos Redigidos Individualmente e Opinião Particular | [Guilherme Flyan](https://www.github.com/GFlyan) |  [Marjorie](https://www.github.com/Marjoriemitzi)
| 1.8 | 24/04/2026 | Padronização dos nomes dos participantes, inserção dos links do GitHub e organização das tabelas | [Gabriel Santos Pinto](https://github.com/GabrielSPinto) | [Ana Carolina Madeira Fialho](https://github.com/anawcarol) |
| 1.8 | 24/04/2026 | Adição de Textos Redigidos Individualmente e Opinião Particular | [Davi Negreiros](https://www.github.com/DaviNegreiros) | 
| 1.9 | 24/04/2026 | Ajustes na documentação | [Maria Samara Alves](https://github.com/SamaraAlvess) | [Gabriel Pinto](https://github.com/GabrielSPinto) |
| 1.10 | 24/04/2026 | Ajustes na documentação, diagrama de classes | [Ana Carolina Fiaho](https://github.com/anawcarol) | [Maria Samara Alves](https://github.com/SamaraAlvess) |
