...
<font size="3"><p style="text-align: center">Tabela 3: Opiniões pessoais</p></font>

| Autor | Função | Comentário |
| :--- | :--- | :--- |
| [Ana Carolina Madeira Fialho](https://github.com/anawcarol) | Fatoração | Contribuí na organização inicial das classes, atributos e relacionamentos do diagrama. |
| [Gabriel Santos Pinto](https://github.com/GabrielSPinto) | Revisão | Revisei a estrutura final do diagrama, verificando sua consistência e clareza. |
